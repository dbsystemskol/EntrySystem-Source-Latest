...
namespace EntrySystem.Forms
{
    public partial class frmStudent : Form
    {
        ...
        private void btnGetData_Click(object sender, EventArgs e)
        {
            ...
            ResetFields();
            //Boolean ExistInStudentMaster = false;
            //ExistInStudentMaster = objStudent.ExistInStudentMasterID(txtGetRegistrationNo.Text.Trim().ToString());
           
            _mList = objStudent.GetStudentRecordByRegNo(txtGetRegistrationNo.Text.ToString().Trim());
            if (_mList.Count > 0 )
            {
                ...
                txtRegNo4.Text = "";
                txtRegNo5.Text = "";
                if (txtGetRegistrationNo.Text.ToString().Trim().Length == 16)
                {
                    txtRegNo1.Text = (txtGetRegistrationNo.Text.Substring(0, 2));
                    txtRegNo2.Text = (txtGetRegistrationNo.Text.Substring(2, 2));
                    txtRegNo3.Text = (txtGetRegistrationNo.Text.Substring(4, 4));
                    txtRegNo4.Text = (txtGetRegistrationNo.Text.Substring(8, 6));
                    txtRegNo5.Text = (txtGetRegistrationNo.Text.Substring(14, 2));
                }
                else if (txtGetRegistrationNo.Text.ToString().Trim().Length == 17)
                {
                    txtRegNo1.Text = (txtGetRegistrationNo.Text.Substring(0, 2));
                    txtRegNo2.Text = (txtGetRegistrationNo.Text.Substring(2, 3));
                    txtRegNo3.Text = (txtGetRegistrationNo.Text.Substring(5, 4));
                    txtRegNo4.Text = (txtGetRegistrationNo.Text.Substring(9, 6));
                    txtRegNo5.Text = (txtGetRegistrationNo.Text.Substring(15, 2));
                }
               // getStudentID();
        ...
        {
            List<StudentMasterInfo> _mList1 = new List<StudentMasterInfo>();
            _mList1 = objStudent.GetStudentIDByRegNo(txtGetRegistrationNo.Text.Trim().ToString());
            if (_mList1.Count > 0)
            {
                txtGetStudentID.Text = _mList1[0].StudentId;
                txtStudentID.Text = _mList1[0].StudentId;

                if (txtGetRegistrationNo.Text.Length == 16)
                {
                    txtRegNo1.Text = (txtGetRegistrationNo.Text.Substring(0, 2));
                    txtRegNo2.Text = (txtGetRegistrationNo.Text.Substring(2, 2));
                    txtRegNo3.Text = (txtGetRegistrationNo.Text.Substring(4, 4));
                ...
                else if (txtGetRegistrationNo.Text.Length == 17)
                {
                    txtRegNo1.Text = (txtGetRegistrationNo.Text.Substring(0, 2));
                    txtRegNo2.Text = (txtGetRegistrationNo.Text.Substring(2, 3));
                    txtRegNo3.Text = (txtGetRegistrationNo.Text.Substring(5, 4));
        ...
        private void BindLIUESubject()
        {
            ...
            _mListLIUE.Clear();
            _mListLIUE = objSubject.GetSubject("H", "LIEU");
        ...
        private void BindElectiveSubject()
        {
            ...
            if (txtGetStudentID.Text.Substring(2, 1)=="M")
                _mListELECTIVE = objSubject.GetSubject("H", "ELECTIVE");
            else
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ddlNatureOfEntry.Text == "Addition")
            {
                ...
                //objStudentMasterInfo.Gender = ddlGender.Text;
        ...
        private void ddlMILSubject_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (txtGetStudentID.Text.Length == 13)
            {
                if (ddlMILSubject.SelectedIndex > 0)
                {
                    ...
                    List<SubjectMasterInfo> _mListELECTIVE = new List<SubjectMasterInfo>();
                    string _Elec = txtGetStudentID.Text.Substring(2, 1) == "M" ? "H" : txtGetStudentID.Text.Substring(2, 1);
                    var Result = _mListELECTIVE = objSubject.GetSubject(_Elec, "ELECTIVE");
                    if (part.Length > 0)
